<!-- drawer component -->
<div id="drawer-cart-filter" class="fixed shadow-2xl top-0 right-0 z-50 h-screen overflow-y-auto transition-transform {{ $isHideDrawer ? 'translate-x-full' : 'transform-none' }} w-3/4 sm:w-[500px] bg-white" tabindex="-1" aria-labelledby="drawer-cart-filter-label">    
    <div class="overflow-auto py-10 px-3 sm:pb-10">
        <ul class="space-y-2 font-medium">
            <li>
                <button type="button" class="flex items-center w-full px-3 py-2 bg-primary text-white" aria-controls="dropdown-filter-price" data-collapse-toggle="dropdown-filter-price" aria-expanded="true">
            ...
            <li>
               <button type="button" class="flex items-center w-full px-3 py-2 bg-primary text-white" aria-controls="dropdown-filter-category" data-collapse-toggle="dropdown-filter-category" aria-expanded="true">
