<div>
    <div class="card-body relative overflow-x-auto shadow-md border">
        <form action="{{ url('/pengguna/kelola-pengguna/edit/'.$user['id']) }}" method="POST">
            @csrf
            ...
            <div class="flex justify-between items-center">
                <a href="{{ route('admin.pengguna.kelola-pengguna') }}" wire:navigate class="flex items-center space-x-2 bg-primary text-white text-sm focus:ring-4 focus:outline-none focus:ring-primary rounded-sm py-2 pr-3 pl-2">
                ...
                <button type="submit" class="flex items-center space-x-2 bg-primary text-white text-sm focus:ring-4 focus:outline-none focus:ring-primary rounded-sm py-2 pr-3 pl-2">
