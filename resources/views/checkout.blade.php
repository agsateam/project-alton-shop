        ...
        <div class="w-full py-5 px-5 md:px-10">
            ...
            <div class="pb-10 w-full">
                ...
                <div class="flex flex-col md:flex-row">
                    <x-select-float-label name="province" label="Provinsi" class="w-full md:w-1/2 mt-1 mb-2"/>
                    <x-select-float-label name="city" label="Kota" class="w-full md:w-1/2 md:ml-2 mt-1 mb-2">
                        <option selected disabled>Pilih Kota</option>
                        <option disabled>Pilih provinsi lebih dulu.</option>
                    </x-select-float-label>
                </div>
                <div class="flex flex-col md:flex-row">
                    <x-select-float-label name="district" label="Kecamatan" class="w-full md:w-1/2 mt-1 mb-2">
