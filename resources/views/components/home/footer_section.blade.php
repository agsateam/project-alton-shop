<footer class="footer p-8 bg-primary text-white shadow-lg">
    <aside class="pl-20 hidden lg:flex lg:flex-col">
    <a href="/" wire:navigate class="text-6xl lg:ml-5 sm:ml-3">ALTON
      ...
      <div id="accordion-kategori" class="hidden w-full" aria-labelledby="accordion-flush-kategori">
        <div>
          <p class="mb-3 mt-1 text-white flex flex-col">
            <a href="" class="mb-1 text-xs">Baby & Kids</a>
            <a href="" class="mb-1 text-xs">Set</a>
            <a href="" class="mb-1 text-xs">Atasan</a>
            <a href="" class="mb-1 text-xs">Muslim</a>
            <a href="" class="mb-1 text-xs">Aksesoris</a>
            <a href="" class="mb-1 text-xs">Lainnya</a>
          </p>
        </div>
      </div>
    </div>
    <div id="accordion-flush-informasi" data-accordion="collapse" data-active-classes="text-white" data-inactive-classes="text-white" class="w-full md:hidden">
      ...
      <div id="accordion-informasi" class="hidden" aria-labelledby="accordion-flush-informasi">
        <div>
          <p class="mb-3 mt-1 text-white flex flex-col">
            <a href="" class="mb-1 text-xs">Panduan</a>
            <a href="" class="mb-1 text-xs">Syarat & Ketentuan</a>
            <a href="" class="mb-1 text-xs">Kebijakan Privasi</a>
            <a href="" class="mb-1 text-xs">Tentang kami</a>
            <a href="" class="mb-1 text-xs">FAQ</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="lg:hidden md:hidden flex">
      <div>
        <a href="/" wire:navigate class="text-6xl">ALTON
          <div class="pt-2 relative flex items-center">
              <div class="flex-grow border-t border-white"></div>
          </div>
          </a>
      ...
      <nav class=" md:flex md:flex-col">
        <div class="mb-3">
          <a><span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#fff]">
    ...
    <nav class="pl-3 hidden md:flex md:flex-col">
      ...
      <a class="link link-hover">Baby & Kids</a>
      <a class="link link-hover">Set</a>
      <a class="link link-hover">Atasan</a>
      <a class="link link-hover">Muslim</a>
      <a class="link link-hover">Aksesoris</a>
      <a class="link link-hover">Lainnya</a>
    </nav> 
