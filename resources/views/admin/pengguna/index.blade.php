                        ...
                        @foreach ($users as $user)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                                ...
                                <td class="px-6 py-4 flex items-center place-content-center space-x-2">
                                    ...
                                    <a href="{{ url('admin/pengguna/kelola-pengguna/delete/'.$user->id) }}" class="flex items-center space-x-2 font-medium text-white bg-red-500 rounded-sm py-2 pl-2 pr-3" onclick="return confirm('Apa anda yakin akan menghapus data ini ?')">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
