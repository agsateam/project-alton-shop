<x-account-layout>
  <x-master.accountLayout>
    {{-- content account --}}
    <div class="container md:px-3 md:py-5 mx-auto">
      <div class="flex md:flex-wrap md:-m-4 justify-between">
        ...
        <div class="p-2 w-1/4 md:flex md:flex-wrap">
          <div class="relative h-20 w-34 md:h-32 md:w-52 border-primary shadow-lg px-2 py-1 md:px-4 md:py-6 rounded-lg text-sky-500">
            <svg class="text-sky-500 mr-2 md:mr-4 h-6 w-6 md:h-12 md:w-12 absolute right-0 top-1/4 md:top-1/2 transform -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h6l2 4m-8-4v8m0-8V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v9h2m8 0H9m4 0h2m4 0h2v-4m0 0h-5m3.5 5.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm-10 0a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
            </svg>            
            <h2 class="title-font text-sky-500 font-bold text-2xl md:text-5xl">5</h2>
            <span class="text-xs ml-2 mb-1 md:ml-4 md:mb-3 text-sky-500 md:text-md md:text-xl leading-relaxed absolute bottom-0 left-0">Delivery</p>
          </div>
        </div>
        <div class="p-2 w-1/4 md:flex md:flex-wrap">
          <div class="relative h-20 w-34 md:h-32 md:w-52 border-primary shadow-lg px-2 py-1 md:px-4 md:py-6 rounded-lg">
            ...
            <h2 class="title-font font-bold text-2xl md:text-5xl">12</h2>
            <span class="text-xs ml-2 mb-1 md:ml-4 md:mb-3 text-slate-200 md:text-md md:text-xl leading-relaxed absolute bottom-0 left-0">Completed</p>
          </div>
        </div>
        <div class="p-2 w-1/4 md:flex md:flex-wrap">
          <div class="relative h-20 w-34 md:h-32 md:w-52 border-primary shadow-lg px-2 py-1 md:px-4 md:py-6 rounded-lg">
            ...
            <h2 class="title-font font-bold text-2xl md:text-5xl">9</h2>
            <span class="text-xs ml-2 mb-1 md:ml-4 md:mb-3 text-slate-200 md:text-md md:text-xl leading-relaxed absolute bottom-0 left-0">Canceled</p>
          </div>
        </div>
      </div>
      <div class="flex w-full my-8">
        <div class="shadow-xl h-full w-full px-2 py-1 rounded-xl">
          <ul class="flex flex-row overflow-auto border-b-2 border-gray-200 w-full justify-around text-md font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
            ...
            <li role="presentation">
                <button class="inline-block p-4 hover:border-b-2 text-primary font-semibold hover:border-gray-300" id="delivery-tab" data-tabs-target="#delivery" type="button" role="tab" aria-controls="delivery" aria-selected="false">Delivery</button>
            </li>
            <li role="presentation">
                <button class="inline-block p-4 hover:border-b-2 text-primary font-semibold hover:border-gray-300" id="completed-tab" data-tabs-target="#completed" type="button" role="tab" aria-controls="completed" aria-selected="false">Completed</button>
            </li>
            <li role="presentation">
                <button class="inline-block p-4 hover:border-b-2 text-primary font-semibold hover:border-gray-300" id="pending-tab" data-tabs-target="#pending" type="button" role="tab" aria-controls="pending" aria-selected="false">Pending</button>
            </li>
            <li role="presentation">
